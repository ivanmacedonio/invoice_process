...
from app.domain.entities.dtos.arca_bill_dto import ARCABillDTO
from datetime import datetime
from dataclasses import asdict
from app.domain.utils.validate_fields import validate_fields
from app.domain.interfaces.arca_interface import IBillingService, IBuildManager, IInstanceManager
...
class BillingService(IBillingService):
    ...
    def bill(self, transaction: dict) -> dict:
        ...
        logger.info(f'ARCA Response: {arca_response}')
