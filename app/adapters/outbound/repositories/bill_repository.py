...
from app.domain.entities.dtos.invoice_payloads_dto import ClientDTO, SellDTO
from sqlalchemy import exc
from app.domain.entities.models.models import Factura, Facturante, Cliente, Venta
from uuid import uuid4
from app.domain.decorators.transactional import transactional
from app.domain.interfaces.bill_repository_interface import IBillRepository
